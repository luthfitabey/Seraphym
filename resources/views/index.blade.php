...
<html>
  <head>
    ...
    <link rel="stylesheet" type="text/css" href="{{ asset('fragrant/style.css') }}">
  ...
  <body class="bg-body" data-bs-spy="scroll" data-bs-target="#navbar" data-bs-root-margin="0px 0px -40%" data-bs-smooth-scroll="true" tabindex="0">
      ...
      <nav id="header-nav" class="navbar navbar-expand-lg">
        <div class="container-fluid">
          <a class="navbar-brand" href="index.html">
            <img src="{{ asset('fragrant/images/main-logo.png') }}" class="logo">
          </a>
    ...
    <section id="instagram" class="py-lg-7" data-aos="fade-up">
      <div class="container-lg">
        <div class="row">
          ...
          <div class="col-lg-2 col-md-6 mb-3">
            <img src="{{ asset('fragrant/images/insta-item2.jpg') }}" alt="instagram" class="img-fluid">
          </div>
          <div class="col-lg-2 col-md-6 mb-3">
            <img src="{{ asset('fragrant/images/insta-item3.jpg') }}" alt="instagram" class="img-fluid">
          </div>
          <div class="col-lg-2 col-md-6 mb-3">
            <img src="{{ asset('fragrant/images/insta-item4.jpg') }}" alt="instagram" class="img-fluid">
          </div>
          <div class="col-lg-2 col-md-6 mb-3">
            <img src="{{ asset('fragrant/images/insta-item5.jpg') }}" alt="instagram" class="img-fluid">
          </div>
          <div class="col-lg-2 col-md-6 mb-3">
            <img src="{{ asset('fragrant/images/insta-item6.jpg') }}" alt="instagram" class="img-fluid">
          </div>
        </div>
      </div>
    </section>
    ...
    <script src="{{ asset('fragrant/js/jquery.min.js') }}"></script>
    <script src="https://cdnjs.cloudflare.com/ajax/libs/waypoints/4.0.1/jquery.waypoints.js"></script>
    <script src="https://cdn.jsdelivr.net/npm/bootstrap@5.3.0-alpha3/dist/js/bootstrap.bundle.min.js" integrity="sha384-ENjdO4Dr2bkBIFxQpeoTz1HIcje39Wm4jDKdf19U8gI4ddQ3GYNS7NTKfAdVQSZe" crossorigin="anonymous"></script>
    <script src="https://cdn.jsdelivr.net/npm/swiper@10/swiper-bundle.min.js"></script>
    <script src="{{ asset('fragrant/js/plugins.js') }}"></script>
