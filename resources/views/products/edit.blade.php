        ...
        <div class="row mt-3">
            ...
            <div class="col-xs-12 col-sm-12 col-md-12">
                <div class="form-group">
                    ...
                    <textarea class="form-control" style="height:150px" name="description" placeholder="Deskripsi Produk">{{ $product->description }}</textarea>
                </div>
            </div>
            <div class="col-xs-12 col-sm-12 col-md-12">
                <div class="form-group">
            ...
            <div class="col-xs-12 col-sm-12 col-md-12">
                <div class="form-group">
                    ...
                    <img src="{{ asset('images/' . $product->image) }}" width="100px" class="mt-2">
                </div>
            </div>
